...
export function openProfileChooserModal( plugin : WordpressPlugin ) : Promise<WpProfile>
{
...
class WpProfileChooserModal extends AbstractModal
{
    ...
    constructor( readonly plugin : WordpressPlugin, private readonly onChoose : ( profile : WpProfile ) => void )
    {
        super( plugin );
