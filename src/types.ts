...
{
    return ( typeof obj === "object" && obj !== null && "mimeType" in obj && typeof obj.mimeType === "string" && "fileName" in obj && typeof obj.fileName === "string" && "content" in obj && obj.content instanceof ArrayBuffer );
}
...
export class FormItems
{
    ...
    toArrayBuffer( option : {
        boundary : string; nameMapper? : FormItemNameMapper;
    } ) : Promise<ArrayBuffer>
    {
        const CRLF = "\r\n";
