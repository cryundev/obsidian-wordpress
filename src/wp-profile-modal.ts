...
export function openProfileModal( plugin : WordpressPlugin, profile : WpProfile = {
    name : "", apiType : ApiType.XML_RPC, endpoint : "", xmlRpcPath : "/xmlrpc.php", saveUsername : false, savePassword : false, isDefault : false, lastSelectedCategories : [ 1 ]
}, atIndex = -1 ) : Promise<{ profile : WpProfile, atIndex? : number }>
{
...
class WpProfileModal extends AbstractModal
{
    ...
    onOpen()
    {
        ...
        const renderProfile = () =>
        {
            ...
            content.createEl( "p", {
                text : apiDesc, cls : "setting-item-description"
            } );
    ...
    private async refreshWpComToken() : Promise<void>
    {
        ...
        await OAuth2Client.getWpOAuth2Client( this.plugin )
        .getAuthorizeCode( {
            redirectUri : WP_OAUTH2_REDIRECT_URI, scope : [ "posts", "taxonomy", "media", "sites" ], blog : this.profileData.endpoint, codeVerifier : AppState.codeVerifier
        } );
    }
